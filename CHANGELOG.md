...
- Update com.fasterxml.jackson.core:jackson-databind to version 2.21.5
...
### Changed
### Fixed
- fixed security issue spring-boot-starter-parent. upgraded to 3.5.14
- Update postgres dependency version to 42.7.11
...
### Changed
### Fixed
- fixed security issue spring-core. upgraded to 6.2.11

...
public class RegistryProperties
{
	...
	/**
	 * This wildcard prefix is used to make specificAssetIds public for
	 * everyone. The default-value "PUBLIC_READABLE" is used by all catenaX
	 * participants.
	 */
	...
	/**
	 * This wildcard-allowed-types is used to make only specificAssetIds public
	 * for defined types.
	 */
	...
	{
		/**
		 * The identityProvider that should be used. Allowed are keycloak or
		 * cognito
		 */
		...
		/**
		 * The internal client id used for writing operations to registry. Used
		 * if identity provider is cognito
		 */

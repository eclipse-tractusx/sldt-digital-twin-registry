...
public class SubmodelExtensionRefersToReferenceParent {
   ...
   @JsonIgnore
   @OneToMany(cascade = CascadeType.ALL, orphanRemoval=true,mappedBy = "submodelExtensionRefersToReferenceParent")
   //@MappedCollection(idColumn = "fk_reference_parent_id")
   Set<SubmodelExtensionRefersToReferenceKey> keys;

   @JsonBackReference
   @OneToOne(fetch = FetchType.LAZY)
   @JoinColumn(name = "fk_submodel_extension_refers_referred_id")

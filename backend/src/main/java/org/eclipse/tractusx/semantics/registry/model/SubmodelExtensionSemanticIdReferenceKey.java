...
public class SubmodelExtensionSemanticIdReferenceKey {
   ...
   @JoinColumn(name = "fk_submodel_extension_semantic_reference_id")
   private SubmodelExtensionSemanticIdReference submodelExtensionSemanticIdReference;

   @JsonBackReference
   @ManyToOne(fetch = FetchType.LAZY)
   @JoinColumn(name = "fk_reference_parent_id")
   private SubmodelExtensionSemanticIdReferenceParent submodelExtensionSemanticIdReferenceParent;
}
